    ...
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-gray-900 dark:text-gray-100">
                La autentificación en dos pasos está activada.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-900 dark:text-gray-100">
                Termina de confirmar la autentificación en dos pasos.
            </h3>

            <h3 v-else class="text-lg font-medium text-gray-900 dark:text-gray-100">
                No has activado la autentificación en dos pasos.
            </h3>

            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    Cuando la autentificación de dos pasos está activa, se le pedirá un token seguro y aleatorio durante la autentificación. Puedes recibir este token desde tu telefono con la aplicación de autentificación de google.
                </p>
            </div>
                ...
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            Para finalizar el proceso de activado de la autentificación en dos pasos, escanee el siguiente código QR usando la aplicación de autenticación de su teléfono o ingrese la clave de configuración.
                        </p>

                        <p v-else>
                            La autentificación de dos pasos está ahora activada. Escanee el siguiente código QR usando la aplicación de autenticación de su teléfono o ingrese la clave de configuración.
                        </p>
                    </div>
